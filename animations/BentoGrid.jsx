...
const cardData = [
  {
    color: '#060010',
    title: '2+',
    description: 'Years of building web applications',
    label: 'Experience',
    titleFontSize: '6xl',
  ...
  },
  {
    color: '#060010',
    title: '10+',
    description: 'Production level projects completed',
    label: 'Projects',
    titleFontSize: '6xl',
    titleFontWeight: 'bold'
  },
...
const BentoCardGrid = ({ children, gridRef }) => (
  <div
    className="bento-section grid gap-2 w-full max-w-(--content-width) select-none relative"
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {cardData.map((card, index) => {
            const baseClassName = `card flex flex-col justify-between relative min-h-[200px] w-full max-w-full p-5 rounded-[20px] border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] ${enableBorderGlow ? 'card--border-glow' : ''
              }`;
